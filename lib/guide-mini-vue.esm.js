...
function createRenderer(options) {
    const { createElement, patchProps, patchEvent, insert, } = options;
    /**
     * 渲染器
     * @param vnode 虚拟节点
...
export { Fragment, Text, createApp, createComponentInstance, createRenderer, createTextVNode, createVNode, getCurrentInstance, h, inject, provide, renderSlots, setupComponent };
